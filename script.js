...
/* harmony import */ var _modules_showMoreFiles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showMoreFiles */ "./src/js/modules/showMoreFiles.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-modal]');
  ...
  Object(_modules_showMoreFiles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
...
var accordion = function accordion(triggersSelector, itemSelectors) {
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    if (menuElem.style.display == "none" && window.screen.availWidth < 992) {
      // availWidth ширина конента бз меню и проч
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var sum = 0;
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["getResourse"])('http://localhost:3000/sizes').catch(function (error) {
    console.log(error);
    var errorMessage = document.createElement('div');
    document.querySelector(result).appendChild(errorMessage);
    errorMessage.innerHTML = "<p>\u0421\u0435\u0440\u0432\u0435\u0440 \u043D\u0435 \u043E\u0442\u0432\u0435\u0447\u0430\u0435\u0442, \u043E\u0448\u0438\u0431\u043A\u0430: ".concat(error, "</p>");
  }).then(function (res) {
    createForm(res);
  });
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markShowSelector) {
    var markType = wrapper.querySelectorAll(markShowSelector);
  ...
  var markShow = function markShow(Selector) {
  ...
  markShow('.guy');
  markShow('.granddad');
  markShow('.grandmother'); // btnAll.addEventListener('click', () => {
  // 	typeFilter(markAll);
  // });
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      // подставляем в файлИнпут название файла и ставим точки если длинный
  ...
  form.forEach(function (formItem) {
    formItem.addEventListener('submit', function (e) {
      e.preventDefault();
      var uploadInput = formItem.querySelector('[name="upload"]'),
          formSelects = formItem.querySelectorAll('select'),
          formPhone = formItem.querySelector('[name="phone"]');
      console.log(formSelects); // console.log(uploadInput.previousElementSibling.textContent);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    this.value = matrix.replace(/[_\d]/g, function (a) {
      return val.charAt(i++) || '_'; // if (/[_\d]/.test(a) && i < val.length) {
      // 	return val.charAt(i++);
    ...
    this.value.split('').forEach(function (a, index) {
      if (!isNaN(a) && a != ' ') i = index + 1;
    });
    setCursorPosition(i, this);
    console.log(i); // if (event.type === 'blur') {
  ...
  var inputs = document.querySelectorAll(selector);
  inputs.forEach(function (input) {
    input.addEventListener('input', createMask); // input.addEventListener('blur', createMask);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _culcScroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./culcScroll */ "./src/js/modules/culcScroll.js");

// import closeModals from "./closeModals";


var modals = function modals(dataModalSelector) {
  ...
  /*, requiredInputsSelector*/
  {
    var triggerDestroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var trigger = document.querySelectorAll(triggerSelector),
        modal = document.querySelector(modalSelector),
        close = document.querySelectorAll(closeSelector),
        windows = document.querySelectorAll(dataModalSelector); // requiredInputs = document.querySelectorAll(requiredInputsSelector);
    ...
    function openWindow() {
      ...
      document.body.style.marginRight = "".concat(Object(_culcScroll__WEBPACK_IMPORTED_MODULE_1__["default"])(), "px");
      trigger.forEach(function (item) {
        if (triggerDestroy) {
          // скрывает trigger 
          item.remove();
    ...
    function closeModals(dataModalSelector) {
      var windows = document.querySelectorAll(dataModalSelector);
      windows.forEach(function (item) {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      var display;
      document.querySelectorAll(dataModalSelector).forEach(function (item) {
      ...
      if (!display) {
        // проверяет были ли открыты модальные окна
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight); // кроссбраузерная проверка

      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeight) {
        // рассчет всей высоты страницы
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var element = document.documentElement,
          body = document.body;
      var widthTop = Math.round(body.scrollTop || element.scrollTop),
          // Свойство scrollTop считывает или устанавливает количество пикселей, прокрученных от верха элемента. scrollTop измеряет дистанцию от верха элемента до верхней точки видимого контента. + проверка!!
      hash = this.hash,
          toBlock = document.querySelector(hash).getBoundingClientRect().top,
          // верхняя граница элемента, к которому скроллим. getBoundingClientRect  позволяет получить доступ к свойствам например Top
      duration = 3000;
      ...
      ;
      var EaseInOutquad = EaseInOut(quad);
      ...
      requestAnimationFrame(function animate(time) {
        ...
        var r = widthTop + toBlock * progress; // колличество пикселей на которое нам необходимо пролистать за время анимации

        element.scrollTo(0, r);
        body.scrollTo(0, r); // if (r != widthTop + toBlock) {
...
var showMoreFiles = function showMoreFiles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    //стрелочная функция не ссылается на this!!!
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])('http://localhost:3000/styles').catch(function (error) {
      console.log(error);
      var errorMessage = document.createElement('div');
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    ...
    prevBtn.addEventListener('click', function () {
      ...
      items[slideIndex - 1].addEventListener('animationend', function () {
